...
namespace CinemaClient
{
    public partial class MakeReservationControl : UserControl
    {
        ...
        private async void LoadSeatsData()
        {
            ...
            try
            {
                EntityList<Seat> response = await Service.GetTakenSeatsAsync(ReservationItem.Showing.Identifier);
                List<Seat> seats = response.List;
        ...
        private void MakeReservationButton_Click(object sender, RoutedEventArgs e)
        {
            if (Utils.Ask(Context, "Czy na pewno chcesz złożyć rezerwację?"))
            {
                ...
                reservation.ShowingID = ReservationItem.Showing.Identifier;
        ...
        private async void MakeReservation(Reservation newReservation)
        {
            ...
            try
            {
                string reservationCode = await Service.MakeReservationAsync(Authorization, newReservation);
        ...
        private async void UpdateReservation(Reservation newReservation)
        {
            ...
            try
            {
                await Service.UpdateReservationAsync(Authorization, ReservationItem.Reservation.Identifier, newReservation);
                newReservation.Identifier = ReservationItem.Reservation.Identifier;
